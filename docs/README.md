# 📚 Plotfolio Documentation

Welcome to the Plotfolio documentation directory. All project documentation files are organized here.
...
- **[State Borders Feature](./STATE_BORDERS_FEATURE.md)** - Interactive state boundary overlays with hover effects
...
├── DOCUMENTATION_GUIDELINES.md        # Guidelines for creating docs
├── BOUNDARY_REGISTRATION_GUIDE.md     # Complete boundary registration guide
└── QUICK_START_BOUNDARIES.md          # Visual quick-start guide
```

## 🔗 External Resources

- **GitHub Repository**: [stadier/plotfolio](https://github.com/stadier/plotfolio)
...
- Add visual diagrams for complex processes
