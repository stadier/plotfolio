...
const sampleProperties: Property[] = [
	...
	// ── Chinedu's properties ────────────────────────────────────
	{
		...
		description:
			"Affordable residential plot in Kubwa with survey plan and deed. Available for short-term rental.",
		state: "Abuja FCT",
		city: "Kubwa",
		country: "Nigeria",
	...
	},
	{
		...
		description:
			"Fertile farmland along the Gwagwalada corridor. Currently uncultivated but road-accessible. Available for long-term lease — ideal for poultry, crop farming, or agri-business.",
		state: "Abuja FCT",
		city: "Gwagwalada",
		country: "Nigeria",
		owner: owners.emmanuel,
	...
	},
	{
		...
		visibility: PropertyVisibility.PUBLIC,
		description:
			"Commercial shop space in Nyanya market extension. Currently under long-term lease to a building materials trader. Solid rental income with committed tenant.",
		state: "Abuja FCT",
		city: "Nyanya",
		country: "Nigeria",
		owner: owners.tunde,
