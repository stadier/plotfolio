...
export default function SummaryStatCard({
	...
	const bg = iconColor?.bg ?? "bg-blue-50";
	const text = iconColor?.text ?? "text-blue-600";

	return (
		<div className="max-w-xs bg-white border border-gray-200 rounded-xl px-5 py-4 flex items-center gap-3">
			<div
